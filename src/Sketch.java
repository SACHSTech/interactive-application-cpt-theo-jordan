...
public class Sketch extends PApplet {
    ...
    int[] clicks = {5, 15, 30, 50, 75, 100, 130};
    ...
    */
    public void displayScore(int clickScore) {
        fill(0);                                          // Black 
        textSize(70);   
        textAlign(LEFT);                                  // Make text appear in left
        text("Clicks: " + clickScore, width - 1150, 95);  // Display # of clicks
    }

    /* 
    */
    public void mousePressed() {
       float distanceMiddleCircle = dist(mouseX, mouseY, circleX, circleY);

       if (distanceMiddleCircle < circleRadius) {
            score++;
       } 
    }
